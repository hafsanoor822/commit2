...
var obtainMarks:number=45
var totalMarks:number=50
...
var priceOfProduct:number=500
if(priceOfProduct>100){
var discountedPrice:number=priceOfProduct-(priceOfProduct*0.1) 
console.log("The discounted price will be=",discountedPrice,"$")
}
else{
var discountedPrice:number=priceOfProduct-(priceOfProduct*0.05) 
console.log("The discounted price will be=",discountedPrice,"$")
}
...
else{console.log("The user is ADULT")}
...
var currentTemp:number=40
if(currentTemp<15){
    console.log("The weather is cold. You should wear warm clothes")
}
else{console.log("The weather is hot. You should wear light clothes")
}
...
else{console.log("The given year is not a leap year")}

//determines the day of the week by number from 1-7
var userNum:number=4
if(userNum==1){
...
//attendance
var attendedClasses:number=17
var totalClasses:number=20
var attPercent:number=(attendedClasses/totalClasses)*100
console.log("the attendance percentage of student is=",attPercent,"%")
//theory
var theory_obMarks:number=27
var theory_t0talMarks:number=40
var theory_per:number=(theory_obMarks/theory_t0talMarks)*100
console.log("The theory percentage of the student is=",theory_per,"%")
//practical
var practical_obMarks:number=13
var practical_t0talMarks:number=20
var practical_per:number=(practical_obMarks/practical_t0talMarks)*100
...
//grading system
var obMarks:number=1031
var t0talMarks:number=1100
var per:number=(obMarks/t0talMarks)*100
